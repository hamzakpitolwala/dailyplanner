...
import { LogOut, Bot, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="h-screen w-full bg-transparent flex flex-col overflow-hidden text-text transition-colors duration-300">
      ...
      <div className="flex-1 w-full max-w-[1920px] mx-auto flex overflow-hidden relative">
        ...
        {/* Right Planner AI Panel (Collapsible) */}
        ...
        <AnimatePresence>
          {!isAiOpen && (
            <motion.button
              ...
              className="absolute bottom-6 right-6 z-30 flex items-center justify-center p-4 bg-primary text-white rounded-2xl shadow-lg hover:bg-primary-hover hover:shadow-xl transition-all"
